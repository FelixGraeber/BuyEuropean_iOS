...
struct ResultsView: View {
    ...
    init(response: BuyEuropeanResponse, onDismiss: @escaping () -> Void) {
        ...
        let initialViewModel = ResultsViewModel(response: response) // Create temporary instance
        _viewModel = StateObject(wrappedValue: initialViewModel)
        // Use the analysisId generated by the ResultsViewModel
        _feedbackViewModel = StateObject(wrappedValue: FeedbackViewModel(analysisId: initialViewModel.analysisId))
    }
